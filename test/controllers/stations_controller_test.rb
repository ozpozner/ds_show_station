...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { iconID: @station.iconID, lan: @station.lan, lon: @station.lon, name: @station.name, numOfConnections: @station.numOfConnections }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { iconID: @station.iconID, lan: @station.lan, lon: @station.lon, name: @station.name, numOfConnections: @station.numOfConnections }
    assert_redirected_to station_path(assigns(:station))
  end
