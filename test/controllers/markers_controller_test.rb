...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { href: @marker.href, iconID: @marker.iconID, lat: @marker.lat, lon: @marker.lon, name: @marker.name, zoom: @marker.zoom }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { href: @marker.href, iconID: @marker.iconID, lat: @marker.lat, lon: @marker.lon, name: @marker.name, zoom: @marker.zoom }
    assert_redirected_to marker_path(assigns(:marker))
  end
